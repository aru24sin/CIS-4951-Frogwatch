...
export default function RecordScreen() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.status}>{isRecording ? 'Recording...' : 'Press to Start Recording'}</Text>
...
const styles = StyleSheet.create({
  ...
  status: { fontSize: 18, marginBottom: 10, color: '#fff' },
  timer: { fontSize: 24, fontWeight: '600', marginBottom: 20 , color: '#fff'},
